...
public class Converter {
  ...
  public void convertExcelToCSV(String strSource, String strDestination)
    ...
    this.convertExcelToCSV(strSource, strDestination,
        Converter.DEFAULT_SEPARATOR, Converter.EXCEL_STYLE_ESCAPING
    );
  }
  ...
  public void convertExcelToCSV(
    ...
    // conventions
    this.convertExcelToCSV(strSource, strDestination,
        separator, Converter.EXCEL_STYLE_ESCAPING
    );
  }
  ...
  public void convertExcelToCSV(
    ...
    // within range.
    if (formattingConvention != Converter.EXCEL_STYLE_ESCAPING &&
        formattingConvention != Converter.UNIX_STYLE_ESCAPING) {
  ...
  private String escapeEmbeddedCharacters(String field) {
    ...
    // convention....
    if (this.formattingConvention == Converter.EXCEL_STYLE_ESCAPING) {
